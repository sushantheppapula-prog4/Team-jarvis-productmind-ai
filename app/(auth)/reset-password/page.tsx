    ...
    <div className="flex min-h-screen bg-[#F9F9F7]">
      <div className="flex w-full items-center justify-center p-8 lg:w-1/2">
        <div className="w-full max-w-sm space-y-12">
          ...
          <form action={resetPassword as any} className="space-y-6">
            <div>
              <label className="block font-mono text-xs font-bold uppercase tracking-widest text-[#111111] mb-2">New Password</label>
